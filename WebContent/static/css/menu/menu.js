 ...
 */
function MenuBar(objName, barName) {
	this.obj = objName;
	...
	this.colors[3] = {
		menuBgColor:"rgb(159,153,138)",/*9F998A*/
		menuBorderColor:"rgb(142,132,107)",/*8E846B*/
		itemBgColor:"#ffffff",/*4C3000*/
		itemBorderColor:"rgb(164,91,19)",/*A45B13*/
		itemBgMoveColor:"rgb(252,211,61)",/*4C3000*/
		itemBorderMoveColor:"rgb(164,91,19)",/*4C3000*/
		itemMoveColor:"rgb(76,48,0)",/*4C3000*/
		itemColor:"rgb(0,116,199)",/*4C3000*/
		menuBarColor:"rgb(76,48,0)",/*4C3000*/
		menuContentColor:"rgb(76,48,0)"/*4C3000*/
	};
	this.font = {
	};
	this.menus = [];
...
/*
 * 添加方法（可供left.html调用添加菜单形成数组并通过下面的MenuBar.toString()方法遍历输出）
 * 首先查看this.menus[menuName]这个菜单（就是一个数组）是否存在。
 * 如果不存在，先创建这个菜单（数组）。
 * 使用menuItemName和url创建MenuItem对象，把MenuItem对象添加到菜单（数组）尾部。
 * frameName -- 指定在哪个帧中打开页面
 */
MenuBar.prototype.add = function(menuName, menuItemName, url, frameName) {
 ...
 */
MenuBar.prototype.menu2Str = function(menuName){
 ...
 */
MenuBar.prototype.item2Str = function(menuItem){
...
*/
MenuBar.prototype.getCurrMenu = function(res) {
	tagName = res.tagName;
...
MenuBar.prototype.attr = function(ele, attrName) {
	if(ele.getAttribute)  {
...
MenuBar.prototype.showMenu = function(evt, menuBar) {
...
// 打开或关闭menu
MenuBar.prototype.openMenu = function(menuBar, menu) {
...
// 更换图片
MenuBar.prototype.changeImg = function (menu, flag) {
...
// 关闭所有menu
MenuBar.prototype.closeMenu = function(menuBar) {
...
MenuBar.prototype.itemMouseMove = function(e) {
...
MenuBar.prototype.itemMouseOut = function(e) {
